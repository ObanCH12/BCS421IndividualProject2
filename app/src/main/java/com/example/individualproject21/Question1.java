    ...
    public void enableAlert(View view) {
        ...
        alert.setPositiveButton("Yes", (dialogInterface, i) -> {
            ...
            if (checkedId == R.id.Answer3) {
                ...
                editor.apply();
                Toast toast = Toast.makeText(Question1.this, "Correct Answer", Toast.LENGTH_LONG);
                toast.show();
            } else {
                Toast toast = Toast.makeText(Question1.this, "Wrong Answer", Toast.LENGTH_LONG);
                toast.show();
            }
            Intent Q = new Intent(getBaseContext(), Question2.class);
            startActivity(Q);
        });
        alert.setNegativeButton("No", (v,a)->{
            Toast.makeText(Question1.this, "Please choose an answer",
