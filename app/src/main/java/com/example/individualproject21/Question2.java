...
public class Question2 extends AppCompatActivity {
    ...
    public void enableAlert(View view) {
        ...
        alert.setPositiveButton("Yes", (dialogInterface, i) -> {
            ...
            if (checkedId == R.id.Answer2) {
                ...
                editor.apply();
                Toast toast = Toast.makeText(Question2.this, "Correct Answer", Toast.LENGTH_LONG);
                toast.show();
            } else {
                Toast toast = Toast.makeText(Question2.this, "Wrong Answer", Toast.LENGTH_LONG);
                toast.show();
            }
            Intent Q = new Intent(getBaseContext(), Question3.class);
            startActivity(Q);
        });
        alert.setNegativeButton("No", (v,a) -> {
            Toast.makeText(Question2.this, "Please choose an answer",
    ...
    public void Submit(View view) {
        ...
        Intent Back = new Intent(getBaseContext(), Question1.class);
        startActivity(Back);
